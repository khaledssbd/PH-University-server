...
const createEnrolledCourseIntoDB = async (
  ...
  ).select('maxCredit'); // field filtering by select
  ...
  try {
    ...
    // setting maxCapacity of OfferedCourse for new students
...
const getEnrolledCoursesByFacultyFromDB = async (
  facultyId: string,
  query: Record<string, unknown>,
) => {
...
const updateEnrolledCourseMarksIntoDB = async (
  ...
  const modifiedData: Record<string, unknown> = {
    ...courseMarks, // not needed (my opinion)
  };
...
export const EnrolledCourseServices = {
  ...
  getEnrolledCoursesByFacultyFromDB,
